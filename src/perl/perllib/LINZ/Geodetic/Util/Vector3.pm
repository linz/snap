#===============================================================================
# Module:            LINZ::Geodetic::Util::Vector3.pm
#
# Version:           $Id: LINZ::Geodetic::Util::Vector3.pm,v 1.2 2000/03/29 21:52:41 cms Exp $  
#
...
#
# History
# $Log: LINZ::Geodetic::Util::Vector3.pm,v $
...
package LINZ::Geodetic::Util::Vector3;
...
#   SUBROUTINE:   new
#
#   DESCRIPTION:  Bless an array reference to LINZ::Geodetic::Util::Vector3
#
...
sub VectorTo {
  my ($self, $trgt ) = @_;
  return new LINZ::Geodetic::Util::Vector3($trgt->[0]-$self->[0],$trgt->[1]-$self->[1],$trgt->[2]-$self->[2]);
  }
