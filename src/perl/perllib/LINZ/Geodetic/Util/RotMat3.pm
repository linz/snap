#===============================================================================
# Module:           LINZ::Geodetic::Util::RotMat3.pm
#
# Version:           $Id: LINZ::Geodetic::Util::RotMat3.pm,v 1.3 2000/07/04 00:28:14 cms Exp $  
#
...
#
# History
# $Log: LINZ::Geodetic::Util::RotMat3.pm,v $
...
#===============================================================================
#
#   Class:       LINZ::Geodetic::Util::RotMat3
#
#   Description: Defines the following routines:
#                  $object = new LINZ::Geodetic::Util::RotMat3($lon, $lat)
#                  $object->ApplyTo($vec)
#                  $object->ApplyInverseTo($vec)
#
#===============================================================================

package LINZ::Geodetic::Util::RotMat3;

use LINZ::Geodetic::Util::Vector3;
...
#                 lat/lon
#                 Usage: $rtopo = new LINZ::Geodetic::Util::RotMat3($lon,$lat)
#
...
#
#   PARAMETERS:   $vec    The vector to apply the rotation to (a LINZ::Geodetic::Util::Vector3)
#
#   RETURNS:      $rvec   The rotated vector (a LINZ::Geodetic::Util::Vector3)
#
#   GLOBALS:
#
#===============================================================================
...
sub ApplyTo {
  my ($self, $vec) = @_;
  return new LINZ::Geodetic::Util::Vector3 (
